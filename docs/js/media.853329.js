...
$(function(){
r=function(){if(thresholdPassed()){dpi=window.devicePixelRatio;if($(window).width()>=960){var e=document.querySelector('.un19');e.setAttribute('src',(dpi>1)?'images/purple-730.png':'images/purple-365.png');}else{var e=document.querySelector('.un19');e.setAttribute('src',(dpi>1)?'images/purple-400.png':'images/purple-200.png');}}};
